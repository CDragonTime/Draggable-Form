...
import { DragItem, Form_Type, getInitFormValue, MAX_INPUT_LENGTH } from './Types';
interface IProps {
  selectData: DragItem;
  ...
  const onSubmit = debounce(async () => {
    form
      ...
      .then((values) => {
        ...
        newSortList[index] = {
          ...newSortList[index],
          createTime: newSortList[index]?.createTime,
          ...values,
  ...
  const copySelectData = () => {
    form
      ...
      .then((values) => {
        ...
        const newData = {
          ...selectData,
          ...{ code: initData?.code, createTime: initData?.createTime },
          title: selectData?.title + '_copy',
        };
            ...
            rules={[
              ...
              },
              {
                ...
                validator: (rule, value) => {
                  ...
                  return filterSortableList.some((v) => v.code === value)
                    ? Promise.reject('Code is a unique field')
                    : Promise.resolve('');
                },
              },
            ]}
