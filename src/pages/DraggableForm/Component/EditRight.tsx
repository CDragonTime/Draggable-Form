...
import { Button, Col, Form, Input, Row, Select, Space, Switch, Tooltip, message } from 'antd'
        ...
        <Form form={form} layout='vertical' onFinish={onSubmit}>
          ...
          {formInclude?.includes(Form_Type.FORM_TITLE) && (
            <Form.Item
              ...
              label={`Form Title(less than ${MAX_INPUT_LENGTH + 150} words)`}
              rules={[{ required: true, message: 'input' }]}
            >
              <Input maxLength={MAX_INPUT_LENGTH + 150} placeholder='input placeholder' onChange={onSubmit} />
            </Form.Item>
          )}
